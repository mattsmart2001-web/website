...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .static-section { position: absolute; left: 0; top: 0; width: 280px; height: 100%; background: linear-gradient(90deg, var(--bg-color) 0%, var(--bg-color) 85%, transparent 100%); border-right: 2px solid var(--border-color); display: flex; flex-direction: column; justify-content: center; align-items: flex-start; padding: 0 20px; gap: 6px; z-index: 5; }
        .flag-psn { display: flex; align-items: center; gap: 8px; }
        .flag-container { font-size: 2.5rem; line-height: 1; filter: drop-shadow(0 0 8px rgba(0, 255, 136, 0.3)); }
        .psn-name { font-size: 0.9rem; font-weight: 700; color: rgba(255, 255, 255, 0.8); text-transform: uppercase; letter-spacing: 1px; }
