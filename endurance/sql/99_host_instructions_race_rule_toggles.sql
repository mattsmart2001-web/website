-- ============================================================
-- 99 Add race rule toggles to the host portal message
--
-- Equal Conditions Mode, Shortcut/Wall/Car Collision Penalty,
-- Ghosting, and Pit Lane Cutting Penalty (added in migration 98)
-- were never wired into notify_lobby_assignments' Race Settings
-- block, so hosts weren't told about them in their portal inbox
-- message even though they'd already been added to the host email.
-- ============================================================
