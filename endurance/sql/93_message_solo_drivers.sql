-- ============================================================
-- 93 Admin -> all solo/unaffiliated drivers
-- Same shape as message_lobby_hosts, scoped to drivers with no
-- current team (current_team_id IS NULL) — lets admins chase them
