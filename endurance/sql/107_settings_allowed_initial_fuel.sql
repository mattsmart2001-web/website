-- ============================================================
-- 107 Settings Allowed, Initial Fuel settings
--
-- Two more GT7 Custom Race lobby settings, same nullable pattern as
-- migrations 98/105/106: unset means not specified yet.
--   settings_allowed — 'brake_balance_only' | 'none'
--   initial_fuel     — 'default' | '50l'
-- ============================================================

ALTER TABLE events
    ADD COLUMN IF NOT EXISTS settings_allowed text,
    ADD COLUMN IF NOT EXISTS initial_fuel     text;
