-- ============================================================
-- 91 Put lobby-host instructions in the host's portal inbox too
--
-- Until now, the race settings / hosting checklist that lobby hosts
-- need only went out by email (send-lobby-host-email). This adds a
-- second, host-only portal message alongside the split-assignment
-- message every driver gets, so hosts see the full instructions in
-- their driver portal as well as their inbox.
-- ============================================================
