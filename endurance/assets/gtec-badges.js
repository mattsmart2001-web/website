    ...
    const CATEGORIES = [
        ...
        },
        {
            ...
            badges: [
                ...
                { key: 'unfinished_business', name: 'Unfinished Business', icon: '🔁', blurb: 'Beat a driver who finished ahead of you in the previous round',
                  evalFn: s => !!(s.secretBadges || {}).unfinished_business },
                { key: 'phoenix',             name: 'Phoenix',             icon: '🔥', blurb: 'Lose 1000 Elo, then climb all the way back',
                  evalFn: s => !!(s.secretBadges || {}).phoenix },
                { key: 'comeback_king',       name: 'Comeback King',       icon: '🚀', blurb: 'Gain 10 or more positions in a single race',
                  evalFn: s => !!(s.secretBadges || {}).comeback_king },
                { key: 'last_to_first',       name: 'Last to First',       icon: '🏁', blurb: 'Start dead last in your split and win the race',
